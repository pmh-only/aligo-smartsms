...
var BASE_URL = 'https://apis.aligo.in';
var API = /** @class */ (function () {
    function API() {
    }
    API.Send = function (key, user_id, sender, options) {
    ...
    API.BulkSend = function (key, user_id, sender, options) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    API.SEND_URL = BASE_URL + '/send/';
    API.BULK_SEND_URL = BASE_URL + '/send_mass/';
    return API;
}());
exports.default = API;
